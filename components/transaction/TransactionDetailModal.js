...
const TransactionProfile = ({ name, handle, avatar, verified }) => {
  ...
  return (
    <div className="flex flex-col items-center space-y-3">
      ...
      <div className="flex flex-col items-center space-y-1 text-[#DCE2F0]">
...
const TransactionDetails = ({ amount, description, transactionDate }) => {
  return (
    <div className="flex flex-col items-center justify-center space-y-4">
      <h3 className="text-6xl font-bold text-[#DCE2F0]">
        {Number(amount).toFixed(1)} SOL
      </h3>
...
const TransactionStatus = ({ status }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-2">
      ...
      <p className="text-lg font-semibold text-[#DCE2F0]">
        {capitalize(status)}
      </p>
    </div>
  );
